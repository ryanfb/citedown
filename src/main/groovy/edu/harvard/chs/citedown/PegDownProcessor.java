...
public class PegDownProcessor {
    ...
    /**
     * Creates a new processor instance with the given {@link edu.harvard.chs.citedown.Extensions} and the default parsing timeout.
     *
    ...
    /**
     * Creates a new processor instance with the given {@link edu.harvard.chs.citedown.Extensions} and parsing timeout.
     *
     * @param options the flags of the extensions to enable as a bitmask
     */
